...
class DeviceSubmersiveScreen extends StatefulWidget {
  const DeviceSubmersiveScreen({super.key});

  @override
  State<DeviceSubmersiveScreen> createState() => DeviceSubmersiveScreenState();
}

class DeviceSubmersiveScreenState extends State<DeviceSubmersiveScreen> {
                        ...
                        child: Row(
                          ...
                          children: [
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Image.asset(AppImages.waterTapPng),
                                height10,
                                Text(
                                  currentState
                                      ? "Main Motor 2"
