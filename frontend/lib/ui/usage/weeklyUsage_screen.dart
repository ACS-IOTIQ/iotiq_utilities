...
class WeeklyusageScreen extends StatefulWidget {
  const WeeklyusageScreen({super.key});

  @override
  State<WeeklyusageScreen> createState() => _WeeklyusageScreenState();
}

class _WeeklyusageScreenState extends State<WeeklyusageScreen> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    Container(
                      ...
                      width5,
                Text("THIS WEEK",style: w400_14Poppins(color: Color(0xff11217D)),),
                width10,
                 Container(
                  height: 12.h,
                  width: 12.w,
                ...
                width5,
                Text("LAST WEEK",style: w400_14Poppins(color: Color(0xff11217D)),)
                  ],
                ),
