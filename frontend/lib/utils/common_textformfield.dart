  ...
  Widget build(BuildContext context) {
    return TextFormField(
        ...
        decoration: InputDecoration(
          ...
          border: OutlineInputBorder(borderRadius: BorderRadius.circular(8.0.r),borderSide: BorderSide(color: Colors.black12)),
          contentPadding: padding ?? EdgeInsets.symmetric(horizontal: 10.w, vertical: 2.h),
          filled: true,
          fillColor: fillColor ?? Colors.white,
          hintStyle: hintStyle ?? w400_13Poppins(color: Appcolors.textColor),
