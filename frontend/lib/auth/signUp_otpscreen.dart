...
class SignUpOtpScreen extends StatefulWidget {
   SignUpOtpScreen({super.key,this.phoneNumber});
  String? phoneNumber;
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                      ...
                      height: 40,
                      child: Text(
                        "We have sent a 6-digit verification code on your phone number ending with ${provider.phoneSignUpController.text}",
                  ...
                  height20,
                   Padding(
                      ...
                      child: SizedBox(
                        ...
                        provider.verifyOtpSignup(_pinPutcontroller.text,context);
