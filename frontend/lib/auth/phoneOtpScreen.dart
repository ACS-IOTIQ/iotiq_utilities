...
class Phoneotpscreen extends StatefulWidget {
   Phoneotpscreen({super.key,this.phoneNumber});
  String? phoneNumber;
...
void startResendTimer() {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                        ...
                        height: 40,
                        child: Text(
                          "We have sent a 6-digit verification code on your phone number ending with ${provider.phoneController.text}",
  ...
  InkWell(
    onTap: () {
      ...
      provider.signIn(widget.phoneNumber!,context);
                  ...
                  height20,
                   Padding(
                      ...
                      child: SizedBox(
                        ...
                        provider.verifyOtpLogin(_pinPutcontroller.text,context);
                                  }
                                }
